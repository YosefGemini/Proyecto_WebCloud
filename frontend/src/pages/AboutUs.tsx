...
import jose_photo from "../assets/profile_photo.jpg";
    ...
    <NavigationLayout selectedPage={2}>
      <div className="mt-[70px] min flex flex-col justify-center items-center">
        ...
        <div className="max-w-6xl py-24 px-6 bg-slate-200 rounded-lg my-20">
          ...
          <div className="md:flex max-w-3xl mx-auto items-center pt-20">
            <img className="md:w-1/3 rounded-lg" src={jose_photo} />
            <div className="md:w-2/3 md:ml-10 mt-8 md:mt-0">
              <p className="leading-normal text-xl">
                "My business revenue is up over 1,200%. Tailwind has helped me
                leverage my time and completely transform my business. Thank
                you!!"
              </p>
              <h6 className="font-bold mt-4 mb-1">Stacey Langford</h6>
              <p>Coghlan Cottage Farms</p>
            </div>
          </div>
        </div>
